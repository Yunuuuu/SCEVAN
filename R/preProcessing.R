...
#' in less than `1%` of cells are removed. Genes are annotated and sorted
...
#' Log-Freeman–Tukey transformation to stabilize variance and a polynomial
...
#' @param perc_genes percentage of cells in which each gene is to be expressed
#' (optional)
...
#' @param AdditionalGeneSets List of additional signatures to be used to search
#' for normal cells (optional)
#' @param SCEVANsignatures Boolean value TRUE to use internal SCEVAN signatures
